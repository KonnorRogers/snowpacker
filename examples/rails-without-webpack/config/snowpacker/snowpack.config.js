...
const ENTRYPOINTS = process.env[`${prefix}_ENTRYPOINTS_DIR`]
...
const plugins = [
  ...
  //   {
  //     entrypoints: `${BUILD_DIR}/${OUTPUT_DIR}/${ENTRYPOINTS}/**/*.js`,
  //     // entrypoints: path.join(BUILD_DIR, OUTPUT_DIR, ENTRYPOINTS, "**", "*.js"),
  //     extendConfig: (config) => {
  //       config.outputOptions.dir = path.join(BUILD_DIR, OUTPUT_DIR)
  //       return config
  //     }
  //   }
  // ]
